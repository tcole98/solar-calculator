...
def calculate_solar_results(building, roof_area_estimation):
    # CONSTANTS
    avg_roof_size = 175
    ...
    state_input = str(building.state)
    ...
    avg_yearly_bill = (avg_kw_per_meter2 * roof_area_estimation.area) * state_result[0]['costPerKWatt']
    ...
    if state_result[0]['country'] == "AU":
        ...
        stc_result = [item for item in stc_json_data if
                      item['postcodeFrom'] > postcode and item['postcodeTo'] > postcode]
